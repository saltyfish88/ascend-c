...
bool OpRunner::RunOp()
{
    ...
    auto ret = aclnnNonMaxSuppressionGetWorkspaceSize(inputTensor_[0], inputTensor_[1], 
                                                      inputTensor_[2], inputTensor_[3], 
                                                      inputTensor_[4], opDesc_->center_point_box,
    ...
    ret = aclnnNonMaxSuppression(workspace, workspaceSize, handle, stream);
