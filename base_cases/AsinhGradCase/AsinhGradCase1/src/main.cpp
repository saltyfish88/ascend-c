...
{
    size_t fileSize = 0;
    ReadFile("../input/input_y.bin", fileSize, runner.GetInputBuffer<void>(0), runner.GetInputSize(0));
    ReadFile("../input/input_dy.bin", fileSize, runner.GetInputBuffer<void>(1), runner.GetInputSize(1));
