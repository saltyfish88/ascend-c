...
bool OpRunner::RunOp()
{
    ...
    auto ret = aclnnIsCloseGetWorkspaceSize(inputTensor_[0], inputTensor_[1], opDesc_->rtol,opDesc_->atol,opDesc_->equal_nan,
    ...
    ret = aclnnIsClose(workspace, workspaceSize, handle, stream);
